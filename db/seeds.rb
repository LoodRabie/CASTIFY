...
producer1 = Producer.create!(name: "Quentin Tarantino", bio: "Award-winning director and producer.", user: user1)
...
dancer5 = Dancer.create!(name: "Martha Graham", age: 96, location: "Pittsburgh, PA", bio: "Pioneer of modern dance and influential choreographer.", user: user10)
